...
const QuotedWorkOrderPDF = ({ workOrder }) => {
      ...
      <Page style={styles.page}>
        ...
        <View style={styles.table}>
          <View style={styles.tableHeader}>
            ...
            <Text style={styles.tableCell}>N.O de cotización</Text>
          ...
          {workOrder.tires.map((tire, index) => (
            <React.Fragment key={index}>
              ...
              >
                ...
                <Text style={styles.tableCell}>{tire.quoteNumber || "-"}</Text>
                <Text style={styles.tableCell}>
                  {tire.status === "Rechazo" ? (
        ...
        <View style={{ marginTop: 10 }}>
          <Text style={styles.sectionContent}>
            Cascos recolectados:{" "}
            <Text style={styles.sectionBold}>{workOrder.tires.length}</Text>
          </Text>
        </View>
      </Page>
    </Document>
...
export default QuotedWorkOrderPDF;
