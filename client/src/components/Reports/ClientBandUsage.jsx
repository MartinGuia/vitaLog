...
// Función para mostrar el porcentaje dentro de cada barra
...
const ClientBandUsage = ({ title, data }) => {
  if (!data || data.length === 0) {
    return <p className="text-center text-gray-400">Sin datos para mostrar</p>;
  }

  // Ordenar por más usadas y tomar las 10 principales
...
export default ClientBandUsage;
